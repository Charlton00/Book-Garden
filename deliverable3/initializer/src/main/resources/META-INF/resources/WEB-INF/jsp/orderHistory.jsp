...
<head>
  ...
  <title>BookstoreHub - Order History</title>
  ...
  <section>
    <div class="order-history">
      ...
      <c:forEach items="${orderHistory}" var="order">
        ...
        <c:forEach items="${order.orderItems}" var="orderItem">
          <div class="order">
            <div class="book-details">
              <img src="${orderItem.cover}" alt="Book 1">
              <div>
                <p>Title: ${orderItem.title}</p>
                <p>Author: ${orderItem.author}</p>
                <p>ISBN: ${orderItem.isbn}</p>
                <p>Copies: ${orderItem.copies}</p>
              </div>
            </div>
        ...
        <h1>Subtotal: $${order.totalPrice}</h1>
      </c:forEach>
