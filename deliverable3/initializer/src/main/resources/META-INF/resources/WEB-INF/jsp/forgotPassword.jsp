  ...
  <section>
    <div class="reset-form">
      ...
      <form:form method="POST" modelAttribute="user">
        <span style="font-size: 12px; color: red">${emptyEmail}</span><span style="font-size: 12px; color: red">${doesNotExistEmail}</span>
        <form:input type="email" placeholder="Email" name="email" id="email" path="email"/>
