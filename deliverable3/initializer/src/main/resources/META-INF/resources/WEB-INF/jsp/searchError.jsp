...
<body>
  ...
  <section>
    <div class="search-results-container">
      ...
      <p>We didn't find exactly what you are looking for, but here are some things you might like.</p>

      <div class="book-item">
        <img src="${book1.cover}" alt="Book Image" class="book-item-image">
        <div class="book-item-details">
          <h3>${book1.title}</h3>
          <p>Author: ${book1.authors}</p>
          <p class="price">Price: $${book1.sellingPrice}</p>
      ...
      <div class="book-item">
        <img src="${book2.cover}" alt="Book Image" class="book-item-image">
        <div class="book-item-details">
          <h3>${book2.title}</h3>
          <p>Author: ${book2.authors}</p>
          <p class="price">Price: $${book2.sellingPrice}</p>
          <form:form method="post" action="/viewBookDetail">
