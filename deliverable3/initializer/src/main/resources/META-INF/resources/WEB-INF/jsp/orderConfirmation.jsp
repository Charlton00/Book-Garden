...
<head>
    ...
    <title>BookGarden - Registration Confirmation</title>
...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="/orderSummary" class="checkout-button"><i class="fa fa-shopping-cart"></i>Checkout</a></li>
            </ul>
        </nav>
    </header>
    ...
    <section>
        <div class="confirmation-message">
            ...
            <p>We sent a confirmation of your order and receipt to your email. Thank you for shopping at Book Garden!
            </p>
            <form:form method="GET" action="/orderHistory">
